...
function($) {
        ...
        DCalendar = function(elem, options) {
            ...
            this.calendar.on('click', '#next', function() { initCreate('next'); })
                ...
                .on('click', '#today', function() {
                    ...
                    /* Calculate year */
                    if (tClass === 'pMDate') { cyear = (cmonth === 0 ? cyear - 1 : cyear); } else if (tClass === 'nMDate') { cyear = (cmonth + 2 === 13 ? cyear + 1 : cyear); }
                    /* Calculate month */
    ...
    $.fn.dcalendarpicker = function(opts) {
        return $(this).each(function() {
            var that = $(this);
            var cal = $('<table class="calendar"></table>'),
                hovered = false,
                selectedDate = false;
